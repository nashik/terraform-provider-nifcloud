		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "virtual_private_address", "192.168.1.1/24"),
					resource.TestCheckResourceAttr(resourceName, "master_private_address", "192.168.1.2/24"),
					resource.TestCheckResourceAttr(resourceName, "slave_private_address", "192.168.1.3/24"),
					...
					resource.TestCheckResourceAttr(resourceNameReplica, "read_replica_private_address", "192.168.1.10/24"),
					...
					resource.TestCheckResourceAttr(resourceNameRestore, "virtual_private_address", "192.168.1.21/24"),
					resource.TestCheckResourceAttr(resourceNameRestore, "master_private_address", "192.168.1.22/24"),
					resource.TestCheckResourceAttr(resourceNameRestore, "slave_private_address", "192.168.1.23/24"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "virtual_private_address", "192.168.2.1/24"),
					resource.TestCheckResourceAttr(resourceName, "master_private_address", "192.168.2.2/24"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckDBInstanceRestoreExists(resourceNameRestore),
					resource.TestCheckResourceAttr(resourceName, "multi_az", "true"),
					resource.TestCheckResourceAttr(resourceName, "read_replica_private_address", "192.168.2.3/24"),
					resource.TestCheckResourceAttr(resourceName, "read_replica_identifier", randName+"-mhareplica"),
				),
			},
			{
				Config: testAccDBInstance(t, "testdata/db_instance_update_multiaz_off.tf", randName),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDBInstanceExists(resourceName, &dbInstance),
					testAccCheckDBInstanceReplicaExists(resourceNameReplica),
					testAccCheckDBInstanceRestoreExists(resourceNameRestore),
